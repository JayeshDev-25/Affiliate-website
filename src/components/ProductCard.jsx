...
const ProductCard = ({ product, onClick }) => {
  ...
  return (
    <article className="product-card" onClick={onClick} tabIndex={0} onKeyDown={(e) => e.key === "Enter" && onClick()} role="button" aria-label={`View details for ${product.title}`}>
      ...
      <div className="pc-body">
        ...
        <div className="pc-footer">
          <button className="pc-cta" aria-label={`View ${product.title} on Amazon`} onClick={(e) => { e.stopPropagation(); onClick(); }}>
            View
